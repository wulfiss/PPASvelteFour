...
<form id="intermediaForm" method="POST" on:submit|preventDefault={onFormSubmit}>
	<div class="collapse collapse-arrow bg-base-200">
		...
		<div class="collapse-title text-xl font-medium">Intermedia</div>
	...
	<div class="collapse collapse-arrow bg-base-200">
		...
		<div class="collapse-title text-xl font-medium">Garras</div>
		<div class="collapse-content">
			<div class="form-control">
				<label class="label cursor-pointer">
	...
	<div class="collapse collapse-arrow bg-base-200">
		<input type="radio" name="my-accordion-2" />
		<div class="collapse-title text-xl font-medium">Eviscerado</div>
		<div class="collapse-content">
			<label class="form-control w-full">
				<div class="label">
